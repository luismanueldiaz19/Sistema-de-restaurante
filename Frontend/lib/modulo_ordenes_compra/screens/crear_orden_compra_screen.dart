...
class _CrearOrdenCompraScreenState
  ...
  Future<void> _procesarOrdenCompra() async {
    final auth = ref.read(authProvider);
    final result = await ref
        .read(ordenCompraFormProvider.notifier)
        .crearOrdenCompra(auth.token!);
    ...
    if (result['success'] && mounted) {
      ...
      final ordenCompraId = result['data']['orden_compra_id'];
      if (ordenCompraId != null) {
        final urlWithToken = Uri.parse(
          "$hostName/api/ordenes-compras/$ordenCompraId/pdf",
        );
      ...
      appBar: AppBar(
        ...
        actions: [
          ...
          _buildCircleButton(
            ...
            tooltip: 'Limpiar Orden de Compra',
          ),
                  ...
                  child: Column(
                    children: [
                      Expanded(
                        child: Container(
                          ...
                          child: CarritoLista(
                            ...
                            onUpdatePrecio: formNotifier.actualizarPrecio,
                      ...
                      PanelTotales(
                        ...
                        onProcesar: _procesarOrdenCompra,
                        esOrdenCompra: true,
                      ),
                    ],
                  ),
  ...
  Widget _buildProductCatalog(
    ...
    OrdenCompraFormNotifier formNotifier,
  ) {
  ...
  Widget _buildProductCard(
    ...
    return InkWell(
      onTap: () {
        showDialog(
          context: context,
          builder: (ctx) => AddProductoOrdenCompraDialog(
            producto: prod,
            onAdd: (item) {
              formNotifier.agregarProducto(item);
            },
          ),
        );
      },
