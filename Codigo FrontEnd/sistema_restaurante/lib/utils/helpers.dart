...
String getDayWritted(String? fecha) {
...
Widget identy(context) =>
    Text('© 2026 Lwader Soft', style: Theme.of(context).textTheme.bodySmall);
    ...
    child: Row(
      ...
      children: [
        Expanded(
          child: Text(
            limitado,
            style: style ?? TextStyle(color: color ?? AppColors.azulOscuro),
